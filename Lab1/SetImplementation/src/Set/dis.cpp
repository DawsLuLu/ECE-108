...
class Relations {
	...
	public: 
		...
		void null2DArray(int v[][10]); ///////////////////////////////////////////////////////////////////////
		void print2DArray(int v[][10]);
		void printArray(int data[]); 
  		void nullArray (int data[]); 
...
void Relations::makeReflexiveAndSymmetric() {
	...
	cout << "makeReflexiveAndSymmetric Runs" << endl;
...
void Relations::completeLikesRelation() {
	...
	cout << "completeLikesRelation Runs" << endl;
...
void Relations::print2DArray(int v[][10]) {
...
void Relations::null2DArray (int v[][10]) {
...
void Relations::nullArray(int data[]) {
...
void Relations::printArray(int data[]) {
...
int main() {
	...
	relationObject.null2DArray(relationObject.Friends);
	relationObject.null2DArray(relationObject.Owns);
	relationObject.null2DArray(relationObject.Likes);
	...
	//relationObject.print2DArray(relationObject.Owns); 
	//relationObject.print2DArray(relationObject.Likes);
	...
	relationObject.null2DArray(relationObject.Similar); 
	relationObject.null2DArray(relationObject.Dissimilar); 
	//relationObject.print2DArray(relationObject.Friends); 
	...
	//cout << "num users " << relationObject.UserSize << " num content " << relationObject.ContentSize << endl; 
	relationObject.fillSimilar(); 
	relationObject.fillDissimilar(); 
	relationObject.createPowerSetAndOutput();

	relationObject.print2DArray(relationObject.Similar); 
	relationObject.print2DArray(relationObject.Dissimilar);
